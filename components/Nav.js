...
export default function Navigation(){
    ...
    return(
        ...
        <View style={{flex:0, flexDirection:'row', justifyContent:'space-around', }}>
                ...
                <Pressable onPress={() => {setActiveTab("tasks"); navigation.navigate('Tasks')}}  style={() => [activeTab === "" ? styles.navActive: styles.navButton, {backgroundColor: '#46b6af'}]}><Image source={require('../assets/Home.png')}></Image></Pressable>
